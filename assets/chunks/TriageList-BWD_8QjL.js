import{d as y,S as v,k as R,o as S,a2 as A,B,E as c,D as l,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-C0nokmv1.js";import{G as h}from"./GoBack-r0ma_61_.js";import{T as D}from"./Toolbar-BMWBsbA3.js";import{R as I}from"./ReusableDataTable-1elQmLjp.js";import{i as n}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-STbLdkUf.js";import H from"./CPR-DX4iJ9Nb.js";import{d}from"./GlobalPropertyStore-C8sj7X0l.js";import{closeVisit as O}from"./visits_service-BrvJYm-T.js";import{H as s}from"./service-D1DJMKmg.js";import{usePatientList as U}from"./patientListStore-Smsr7mlE.js";import{u as E}from"./useAETCStageRealtime-BKxIrWNO.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const J=y({__name:"TriageList",setup(V){const o=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],f={responsive:!0,ordering:!1,buttons:[]},r=U(),{AETCTriageList:m}=v(r),e=()=>{o.value=m.value.map(t=>[t.visit_number,t.given_name,t.family_name,s.toStandardHisTimeFormat(t.arrival_time),s.waitingTime(t.latest_encounter_time),s.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
