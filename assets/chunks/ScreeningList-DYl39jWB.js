import{d as R,L as h,w as T,o as A,W as L,q as B,v as p,t as u,r as C,u as N,j as $,A as i,B as x,K as H}from"../index-CIT-7-LI.js";import{G as O}from"./GoBack-D9lAx6Ob.js";import{T as U}from"./Toolbar-7Y6Nt4MX.js";import{R as k}from"./ReusableDataTable-JB5j_RRQ.js";import{i as o}from"./svg-D4Mhbd11.js";import{c as F,a as J}from"./Alerts-BzF_5ZgR.js";import V from"./CPR-Cdyjd5Pl.js";import{usePatientList as W}from"./patientListStore-D85X_chj.js";import{H as f}from"./service-agfjd94U.js";import{d as b}from"./GlobalPropertyStore-5qEydjBT.js";import{closeVisit as E}from"./visits_service-Cnr12-h_.js";import{u as G}from"./useAETCStageRealtime-Dd3XcI7Y.js";import{useDemographicsStore as M}from"./DemographicStore-fjj7RG6T.js";import{toastWarning as j}from"./toasts-DFYqM1Y5.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=R({__name:"ScreeningList",setup(w){const r=C([]),g=N(),_=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],I={responsive:!0,ordering:!1,buttons:[]},y=M(),c=W(),{AETCScreeningList:d}=h(c),m=t=>{const e=t?.patient||{},s=t?.identifier??t?.ID??e?.identifier??e?.ID;return{patient_id:t?.patient_id??t?.patientID??t?.person_id??e?.patient_id??e?.patientID??e?.person_id,identifier:s,ID:s}},a=()=>{r.value=d.value.map(t=>[t.visit_number,t.given_name,t.family_name,f.toStandardHisTimeFormat(t.arrival_time),f.waitingTime(t.latest_encounter_time),t.last_encounter_creator,P(m(t))])},{setupStageRealtimeUpdates:D,teardownStageRealtimeUpdates:S}=G({onUpdated:a}),P=t=>`
