import{d as $,T as x,k as T,B,E as f,D as b,e as o,f as C,u as O,j as k,z as W,b as d,K as L,R as q}from"../index-C9PslajR.js";import{T as w}from"./Toolbar-r_Vc_iOc.js";import{R as G}from"./ReusableDataTable-Bwuhkh8w.js";import{G as H}from"./GoBack-DGd-xqXg.js";import{c as M}from"./Alerts-C6eZI0wi.js";import{i as _}from"./svg-D0Xk2Rxf.js";import{P as V}from"./patient_opd_list-CJMzSAAK.js";import{P as E,H as v}from"./service-CgqK7dvD.js";import{useDemographicsStore as J}from"./DemographicStore-Bf6Sm_oS.js";import F from"./CPR-B7AbHY5A.js";import{r as j}from"./ipd_context-DobDxsNY.js";import{toastWarning as g}from"./toasts-DM7V9hq_.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=$({__name:"PreAdmissionList",setup(Q){const m=O(),n=k(),I=J(),c=C([]),y=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],P={responsive:!0,ordering:!1,buttons:[]},l=j(),h=o(()=>String(n.query.department||l.department||"").trim()),s=o(()=>String(n.query.ward||l.ward||"").trim()),u=o(()=>String(n.query.wardId||l.wardId||"").trim()),N=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),D=e=>`
