import{d as S,S as v,k as T,o as R,a2 as A,B,E as c,D as m,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-C0nokmv1.js";import{G as h}from"./GoBack-r0ma_61_.js";import{T as D}from"./Toolbar-BMWBsbA3.js";import{R as I}from"./ReusableDataTable-1elQmLjp.js";import{i}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-STbLdkUf.js";import H from"./CPR-DX4iJ9Nb.js";import{usePatientList as O}from"./patientListStore-Smsr7mlE.js";import{H as l}from"./service-D1DJMKmg.js";import{d}from"./GlobalPropertyStore-C8sj7X0l.js";import{closeVisit as U}from"./visits_service-BrvJYm-T.js";import{u as E}from"./useAETCStageRealtime-BKxIrWNO.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const J=S({__name:"ScreeningList",setup(V){const s=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=O(),{AETCScreeningList:r}=v(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,l.toStandardHisTimeFormat(t.arrival_time),l.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
