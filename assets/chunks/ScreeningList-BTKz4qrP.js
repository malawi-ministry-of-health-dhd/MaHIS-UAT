import{d as R,L as h,w as T,o as A,W as L,q as B,v as p,t as u,r as C,u as N,j as $,A as i,B as x,K as H}from"../index-BTkOytnF.js";import{G as O}from"./GoBack-Ccpe8tIu.js";import{T as U}from"./Toolbar-D0V19trw.js";import{R as k}from"./ReusableDataTable-DbFc4LDD.js";import{i as o}from"./svg-D4Mhbd11.js";import{c as F,a as J}from"./Alerts-B6xX78G6.js";import V from"./CPR-D7EUxKH9.js";import{usePatientList as W}from"./patientListStore-DCTmjxYb.js";import{H as f}from"./service-DXzOiDVV.js";import{d as b}from"./GlobalPropertyStore-BCXzYDQ0.js";import{closeVisit as E}from"./visits_service-CHe9MSV9.js";import{u as G}from"./useAETCStageRealtime-B5Yz_4Gz.js";import{useDemographicsStore as M}from"./DemographicStore-COyr9jB-.js";import{toastWarning as j}from"./toasts-rlFmXXZW.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=R({__name:"ScreeningList",setup(w){const r=C([]),g=N(),_=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],I={responsive:!0,ordering:!1,buttons:[]},y=M(),c=W(),{AETCScreeningList:d}=h(c),m=t=>{const e=t?.patient||{},s=t?.identifier??t?.ID??e?.identifier??e?.ID;return{patient_id:t?.patient_id??t?.patientID??t?.person_id??e?.patient_id??e?.patientID??e?.person_id,identifier:s,ID:s}},a=()=>{r.value=d.value.map(t=>[t.visit_number,t.given_name,t.family_name,f.toStandardHisTimeFormat(t.arrival_time),f.waitingTime(t.latest_encounter_time),t.last_encounter_creator,P(m(t))])},{setupStageRealtimeUpdates:D,teardownStageRealtimeUpdates:S}=G({onUpdated:a}),P=t=>`
