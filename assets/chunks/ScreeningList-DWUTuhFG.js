import{d as S,S as v,k as T,o as R,a2 as A,B,E as c,D as m,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-Bya3vcRZ.js";import{G as h}from"./GoBack-hR0kQMIa.js";import{T as D}from"./Toolbar-Djl9QcyI.js";import{R as I}from"./ReusableDataTable-Dg0pU8AN.js";import{i}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-DLvShAsQ.js";import H from"./CPR-BQO5h8PJ.js";import{usePatientList as O}from"./patientListStore-DT8qupop.js";import{H as l}from"./service-8kibqSKY.js";import{d}from"./GlobalPropertyStore-Dvsm8sDL.js";import{closeVisit as U}from"./visits_service-CG2LWJZ3.js";import{u as E}from"./useAETCStageRealtime-CpuNDlJ1.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const J=S({__name:"ScreeningList",setup(V){const s=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=O(),{AETCScreeningList:r}=v(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,l.toStandardHisTimeFormat(t.arrival_time),l.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
