import{d as R,L as h,w as T,o as A,W as L,q as B,v as p,t as u,r as C,u as N,j as $,A as i,B as x,K as H}from"../index-Ju8S2j6V.js";import{G as O}from"./GoBack-75RlidCY.js";import{T as U}from"./Toolbar-CdMfou70.js";import{R as k}from"./ReusableDataTable-DelpaK06.js";import{i as o}from"./svg-D4Mhbd11.js";import{c as F,a as J}from"./Alerts-DPUWNsHc.js";import V from"./CPR-DBKchONh.js";import{usePatientList as W}from"./patientListStore-fQUQ3m7B.js";import{H as f}from"./service-C7G9wP_3.js";import{d as b}from"./GlobalPropertyStore-BtXK2L-I.js";import{closeVisit as E}from"./visits_service-DUHWkZeD.js";import{u as G}from"./useAETCStageRealtime-AuHPsYnE.js";import{useDemographicsStore as M}from"./DemographicStore-CPbOWiBm.js";import{toastWarning as j}from"./toasts-B47RXeVo.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=R({__name:"ScreeningList",setup(w){const r=C([]),g=N(),_=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],I={responsive:!0,ordering:!1,buttons:[]},y=M(),c=W(),{AETCScreeningList:d}=h(c),m=t=>{const e=t?.patient||{},s=t?.identifier??t?.ID??e?.identifier??e?.ID;return{patient_id:t?.patient_id??t?.patientID??t?.person_id??e?.patient_id??e?.patientID??e?.person_id,identifier:s,ID:s}},a=()=>{r.value=d.value.map(t=>[t.visit_number,t.given_name,t.family_name,f.toStandardHisTimeFormat(t.arrival_time),f.waitingTime(t.latest_encounter_time),t.last_encounter_creator,P(m(t))])},{setupStageRealtimeUpdates:D,teardownStageRealtimeUpdates:S}=G({onUpdated:a}),P=t=>`
